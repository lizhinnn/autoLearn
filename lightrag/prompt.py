...
PROMPTS["DEFAULT_ENTITY_TYPES"] = {
    "ControlSystem": "Control Systems (e.g., PID controllers, state feedback controllers)",
    "MathematicalModel": "Mathematical Models (e.g., transfer functions, state-space models)",
    "Component": "Components (e.g., sensors, actuators, filters)",
    "Algorithm": "Algorithms (e.g., Kalman filter, LQR control)",
    "Theorem": "Theorems (e.g., Nyquist stability criterion, Routh-Hurwitz criterion)",
    "Concept": "Concepts (e.g., stability margin, phase margin)",
    "Equation": "Equations (e.g., differential equations, algebraic equations)",
    "Experiment": "Experiments (e.g., step response test, frequency response test)",
    "Application": "Applications (e.g., drone control systems, autonomous vehicles)",
    "Parameter": "Parameters (e.g., gain, time constant)",
    "PerformanceMetric": "Performance Metrics (e.g., rise time, overshoot)",
    "Simulation": "Simulations (e.g., MATLAB/Simulink simulation)",
    "Tool": "Tools (e.g., MATLAB, Python control libraries)",
    "Person": "People (e.g., course professors, researchers)",
    "Organization": "Organizations (e.g., research institutions, universities)",
    "Event": "Events (e.g., academic conferences, seminars)",
    "Publication": "Publications (e.g., papers, books)",
    "Figure": "Figures, such as Figure 1-1, Figure 1-2, etc."
}

# 已修改
PROMPTS["entity_extraction"] = """-Goal-
Given a text document that is potentially relevant to modern control principles and a list of entity types, identify all entities of those types from the text and all relationships among the identified entities. The focus should be on control systems, mathematical models, components, algorithms, theorems, concepts, and their applications.

-Steps-
1. Identify all entities. For each identified entity, extract the following information:
- entity_name: Name of the entity, use same language as input text. If English, capitalize the name.
- entity_type: One of the following types with their descriptions:
...
-Real Data-
######################
Entity_types: {entity_types_with_descriptions}
Text: {input_text}
######################
Output:
"""
